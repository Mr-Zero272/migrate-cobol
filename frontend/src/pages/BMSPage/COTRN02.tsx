  ...
  return (
    <>
      ...
      <GridItem col={30} row={4}>
        <pre style={{ color: "neutral" }}>Add Transaction</pre>
      </GridItem>

      <GridItem col={6} row={6}>
        <pre style={{ color: "turquoise" }}>Enter Acct #:</pre>
      </GridItem>
      ...
      <GridItem col={37} row={6}>
        <pre style={{ color: "neutral" }}>(or)</pre>
      </GridItem>

      <GridItem col={46} row={6}>
        <pre style={{ color: "turquoise" }}>Card #:</pre>
      </GridItem>
      ...
      <GridItem col={6} row={10}>
        <pre style={{ color: "turquoise" }}>Type CD:</pre>
      </GridItem>
      ...
      <GridItem col={23} row={10}>
        <pre style={{ color: "turquoise" }}>Category CD:</pre>
      </GridItem>
      ...
      <GridItem col={46} row={10}>
        <pre style={{ color: "turquoise" }}>Source:</pre>
      </GridItem>
      ...
      <GridItem col={6} row={12}>
        <pre style={{ color: "turquoise" }}>Description:</pre>
      </GridItem>
      ...
      <GridItem col={6} row={14}>
        <pre style={{ color: "turquoise" }}>Amount:</pre>
      </GridItem>
      ...
      <GridItem col={31} row={14}>
        <pre style={{ color: "turquoise" }}>Orig Date:</pre>
      </GridItem>
      ...
      <GridItem col={57} row={14}>
        <pre style={{ color: "turquoise" }}>Proc Date:</pre>
      </GridItem>
      ...
      <GridItem col={13} row={15}>
        <pre style={{ color: "#7faded" }}>(-99999999.99)</pre>
      </GridItem>

      <GridItem col={41} row={15}>
        <pre style={{ color: "#7faded" }}>(YYYY-MM-DD)</pre>
      </GridItem>
      ...
      <GridItem col={6} row={16}>
        <pre style={{ color: "turquoise" }}>Merchant ID:</pre>
      </GridItem>
      ...
      <GridItem col={33} row={16}>
        <pre style={{ color: "turquoise" }}>Merchant Name:</pre>
      </GridItem>
      ...
      <GridItem col={6} row={18}>
        <pre style={{ color: "turquoise" }}>Merchant City:</pre>
      </GridItem>
      ...
      <GridItem col={53} row={18}>
        <pre style={{ color: "turquoise" }}>Merchant Zip:</pre>
      </GridItem>
      ...
      <GridItem col={66} row={21}>
        <pre style={{ color: "neutral" }}>(Y/N)</pre>
      </GridItem>
